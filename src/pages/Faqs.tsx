...
export default function FAQSection() {
  ...
  const faqs = [
    ...
    // },
    {
      question: "Enter Once, Work Less",
      answer:
        "Add client details a single time and NuHelixX RE carries them through every step.",
    },
    {
      question: "Follow-Up Without the Busywork",
      answer:
        "AI handles campaigns and reminders so you can spend more time building relationships.",
    },
    {
      question: "One Platform, Every Deal",
      answer:
        "From first lead to final signature, manage offers, contracts, and closings in one place — no juggling tools, no missed deadlines.",
    },
    {
      question: "Clear Insight",
      answer:
        "Real-time dashboards show where every deal stands, helping you spot bottlenecks, make faster decisions, and keep your pipeline moving.",
    },
  ];
      ...
      <div className="max-w-[full] mx-auto border-t flex flex-col lg:flex-row gap-8 lg:gap-[50px]">
        <div className="flex flex-col justify-around gap-[20px] lg:gap-[30px] mt-[20px] lg:mt-[30px] w-full lg:w-[40%] p-6 lg:p-8 h-auto lg:h-[200px] rounded-2xl bg-white">
          <div className="flex justify-between items-start lg:items-center leading-[30px] lg:leading-[50px]">
            <h2 className="font-[Duck-cry] text-[30px] sm:text-[40px] lg:text-[50px]">Features Built for Real Estate Teams</h2>
